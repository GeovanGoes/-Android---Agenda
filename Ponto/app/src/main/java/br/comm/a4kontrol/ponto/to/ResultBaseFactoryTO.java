package br.comm.a4kontrol.ponto.to;
...
{
	/**
	 * N�mero usado para identificar a classe no processo de serializa��o
	 */
	private static final long serialVersionUID = -9025976238031174022L;

	/***
	 * Atributos est�ticos usados como chaves para a convers�o
	 */
	...
	/** Construtor privado para inicializa��o de um novo objeto de dentro dessa classe */
	...
	/***
	 * M�todo respons�vel por converter o ResultBaseFactory em um Map<String, Object> que pode ser ertornado pela camada Service
	 * 
	 * @return
	 */
	...
	/***
	 * M�todo respons�vel por converter o Map<String, Object> obtido atrav�s da camada Service para um ResultBaseFactory
	 * 
